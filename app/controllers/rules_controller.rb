class RulesController < ApplicationController
  ...
  def apply
    ...
    redirect_back_or_to rules_path, notice: "Pravidlo bolo aktivované."
  end
  ...
  def update
    if @rule.update(rule_params)
      respond_to do |format|
        format.html { redirect_back_or_to rules_path, notice: "Pravidlo bolo upravené." }
        format.turbo_stream { stream_redirect_back_or_to rules_path, notice: "Pravidlo bolo upravené." }
      end
    else
  ...
  def destroy
    @rule.destroy
    redirect_to rules_path, notice: "Pravidlo bolo zmazané."
  end

  def destroy_all
    Current.family.rules.destroy_all
    redirect_to rules_path, notice: "Všetky pravidlá boli zmazané."
  end
