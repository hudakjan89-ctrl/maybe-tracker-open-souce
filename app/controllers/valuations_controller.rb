class ValuationsController < ApplicationController
  ...
  def create
    ...
    if result.success?
      respond_to do |format|
        format.html { redirect_back_or_to account_path(account), notice: "Účet bol upravený." }
        format.turbo_stream { stream_redirect_back_or_to(account_path(account), notice: "Účet bol upravený.") }
      end
    else
  ...
  def update
    ...
    if result.nil? || result.success?
      ...
      respond_to do |format|
        format.html { redirect_back_or_to account_path(@entry.account), notice: "Záznam bol upravený." }
